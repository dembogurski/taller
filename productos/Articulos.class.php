...
class Articulos {
    ...
    private $items = [
        ...
        array("column_name" => "temporada", "nullable" => "YES", "data_type" => "varchar", "max_length" => "30", "numeric_pres" => "", "dec" => "", "titulo_campo" => "Temporada=>", "titulo_listado" => "", "type" => "select", "required" => "", "inline" => "false", "editable" => "Yes", "insert" => "Yes", "default" => "Oto-Inv=>Otoño-Invierno,Pri-Ver=>Primavera-Verano,Perm=>Permanente ", "pk" => "", "extra" => ""),
