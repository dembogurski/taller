...
class UM {
    ...
    private  $items = [array("column_name"=>"um_cod","nullable"=>"NO","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Codigo=>","titulo_listado"=>"Codigo","type"=>"text","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"um_descri","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Descripcion=>","titulo_listado"=>"Descrip","type"=>"text","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"um_ref","nullable"=>"YES","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Referencia=>","titulo_listado"=>"Referencia","type"=>"db_select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"unidades_medida=>um_cod,um_cod","pk"=>"","extra"=>""),
 array("column_name"=>"um_mult","nullable"=>"YES","data_type"=>"decimal","max_length"=>"","numeric_pres"=>"16","dec"=>"3","titulo_campo"=>"Multiplicador=>","titulo_listado"=>"Multiplicador","type"=>"number","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"um_prior","nullable"=>"YES","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Prioridad=>","titulo_listado"=>"Prioridad","type"=>"number","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>"")];    
    private $primary_key = 'um_cod';
    private $limit = 100;
           ...
           foreach ($this->items as $array => $arr) {           
             ...
             if($insert === 'Yes'){
                ...
                if($type == "db_select"){
                    ...
                    $where = "";
                    if($column_name == "um_ref"){
                         $where = " order by um_prior asc;";
                    }
