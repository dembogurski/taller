...
class NotasCreditoAbiertas {
    ...
    function __construct() {
        ...
        $db->Query("SELECT n_nro AS nro,cod_cli,ruc_cli,cliente,usuario,req_auth,autorizado_por,f_nro AS factura,DATE_FORMAT(fecha,'%d-%m-%Y') AS fecha,suc,tipo,total,estado,moneda
