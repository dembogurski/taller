...
function getArticulos(){
    ...
    $ms->Query("select ItemCode,  U_NOMBRE_COM as ItemName from oitm o  where  (ItemCode like 'TX%' and (ItemCode like '$criteria%' or U_NOMBRE_COM like '$criteria%' ))   and FrozenFor = 'N'  ORDER BY ItemCode asc;");
    $arr = array();    
    while($ms->NextRecord()){         
