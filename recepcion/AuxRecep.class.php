...
class AuxRecep {
    ...
    private $table = 'aux_recep';
    private  $items = [array("column_name"=>"id_part","nullable"=>"YES","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Id Part=>","titulo_listado"=>"Id Part","type"=>"number","required"=>"","inline"=>"false","editable"=>"No","insert"=>"Auto","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"descrip","nullable"=>"YES","data_type"=>"varchar","max_length"=>"100","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Descrip=>","titulo_listado"=>"Descripcion","type"=>"text","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"tipo_dato","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo Dato=>","titulo_listado"=>"Tipo Dato","type"=>"select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"boolen=>Si-No,text=>Texto,select=>Select","pk"=>"","extra"=>""),
 array("column_name"=>"opciones","nullable"=>"YES","data_type"=>"varchar","max_length"=>"1024","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Opciones=>","titulo_listado"=>"Opciones","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>"")];    
    private $primary_key = 'id_part';
    private $limit = 100;
    ...
    function main() {
        ...
        $t = new Y_Template("AuxRecep.html");
        $t->Show("headers");
