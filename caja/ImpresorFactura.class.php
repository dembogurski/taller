...
class ImpresorFactura {
    ...
    function __construct() {
        ...
        $sql_tipo = "SELECT tipo_doc_cli FROM factura_venta WHERE f_nro = $factura";
        $db->Query($sql_tipo);
        $db->NextRecord();
        ...
        $this->renderizar($t, $master, $limite_items_x_venta,$decimales,$moneda,$tipo_doc_cli,$factura);
        $t->Show("intervalo");
    ...
    function renderizar($t, $master, $limite_items_x_venta,$decimales,$moneda,$tipo_doc_cli,$factura) {
                $t->Show("cabecera");
