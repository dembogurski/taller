...
function guardarCotiz(cotiz_x,valor,total){
    ...
    $.ajax({
        type: "POST",
        url: "../../Ajax.class.php",
        data: {"action": "guardarCotizControlBilletes",id: id,cotiz_x: cotiz_x,valor: valor,total:total},
        async: true,
        dataType: "html",
        beforeSend: function() {
...
function save(moneda,identif,cant,valor){
    ...
    $.ajax({
        type: "POST",
        url: "../../Ajax.class.php",
        data: {"action": "guardarMoneda", id: id, moneda: moneda,identif:identif,cant:cant,valor:valor},
        async: true,
        dataType: "html",
        beforeSend: function() {
            $("#msg").html("<img src='../../img/loading_fast.gif' width='20px' height='20px' >");                      
...
function cerrarControl(){
    ...
    $.ajax({
        type: "POST",
        url: "../../Ajax.class.php",
        data: {"action": "cerrarControlBilletes", id: id},
        async: true,
        dataType: "html",
        beforeSend: function() {
