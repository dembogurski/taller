...
class Conceptos {
    ...
    private  $items = [array("column_name"=>"id_concepto","nullable"=>"NO","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Id=>","titulo_listado"=>"Id","type"=>"number","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Auto","default"=>"","pk"=>"PRI","extra"=>"auto_increment"),
 array("column_name"=>"descrip","nullable"=>"NO","data_type"=>"varchar","max_length"=>"60","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Descrip=>","titulo_listado"=>"Descrip","type"=>"text","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"tipo","nullable"=>"YES","data_type"=>"varchar","max_length"=>"2","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo=>","titulo_listado"=>"Tipo","type"=>"select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"E=>Entrada,S=>Salida","pk"=>"","extra"=>""),
 array("column_name"=>"autom","nullable"=>"YES","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Automatico=>","titulo_listado"=>"","type"=>"select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"No=>No,Si=>Si","pk"=>"","extra"=>""),
 array("column_name"=>"compl","nullable"=>"YES","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Informacion Complementaria=>","titulo_listado"=>"","type"=>"select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"Si=>Si,No=>No","pk"=>"","extra"=>"")];    
