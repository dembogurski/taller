...
class Bcos_ctas {
    ...
    private $table = 'bcos_ctas';
    private  $items = [array("column_name"=>"id_banco","nullable"=>"NO","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Id Banco=>","titulo_listado"=>"Id Banco","type"=>"db_select","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Yes","default"=>"bancos=>id_banco,nombre","pk"=>"PRI","extra"=>""),
    array("column_name"=>"cuenta","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Cuenta=>","titulo_listado"=>"Cuenta","type"=>"text","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
    ...
    array("column_name"=>"cod_swift","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Cod Swift=>","titulo_listado"=>"","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
    array("column_name"=>"m_cod","nullable"=>"NO","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Moneda","titulo_listado"=>"Moneda","type"=>"db_select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"monedas=>m_cod,m_descri","pk"=>"MUL","extra"=>""),
    array("column_name"=>"estado","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Estado=>","titulo_listado"=>"Estado","type"=>"select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"Activo=>Activo,Inactivo=>Inactivo","pk"=>"","extra"=>"")];    
    ...
    function main() {
        ...
        $t = new Y_Template("Bcos_ctas.html");
        $t->Show("headers");
	$t->Show("insert_edit_form");// Empty div to load here  formulary for edit or new register 	  
        ...
        $Qry = "SELECT  $columns FROM  $this->table where id_banco = $id_banco LIMIT $this->limit"; 
        $db->Query($Qry);
