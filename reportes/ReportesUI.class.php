...
define('path',"$proto://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/sistema"); 
...
class ReportesUI {
   ...
   function __construct() {
    ...
    function main() {
        ...
        createReportButton("10.24", $t, "Fabricacion de Manteles", "logistica gerencia produccion");
        ...
        createReportButton("10.30", $t, "Codificacion Pantone", "stock articulo color pantone");
...
function controles_fuera_rango(){
   $t = new Y_Template("ReportesUI.html");
   //$path = "http://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/marijoa_sap";  
...
function planilla_ordenes_de_compra(){
   ...
   $asoc = getResultArrayMSSQL("select CreditCard, CompanyId, CardName from OCRC where Phone = 'Asociacion'");
...
function fabricacion_de_manteles(){
    $t = new Y_Template("ReportesUI.html");
