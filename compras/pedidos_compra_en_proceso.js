    ...
    $.ajax({
        ...
        success: function (data) {   
            for (var i in data) { 
                ...
                var Ligamento = data[i].U_LIGAMENTO;  
                var Estetica = data[i].U_ESTETITCA;  
                var Tipo = data[i].U_TIPO;  
                var Acabado = data[i].U_ACABADO;  
                var Combinacion = data[i].U_COMBINACION;  
                var Composicion = data[i].U_COMPOSICION;  
                var Ancho = data[i].U_ANCHO;  
                var Gramaje = data[i].U_GRAMAJE_PROM; 
                var UM = data[i].UM;  
