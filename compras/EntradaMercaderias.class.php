...
function buscarArticulos() {
    ...
    $articulos = $fn->getResultArray("SELECT a.codigo, s.descrip AS sector, a.descrip, a.ancho, l.precio ,a.um, a.gramaje_prom , a.costo_prom , a.composicion FROM articulos a, sectores s,  lista_prec_x_art l WHERE a.cod_sector = s.cod_sector AND a.codigo = l.codigo AND l.num = $cat AND l.moneda ='G$'    
...
function getDetalleEntradaMercaderias() {
    ...
    FROM entrada_det d, articulos a WHERE d.codigo = a.codigo AND  id_ent = $id_ent ORDER BY store_no ASC,bale ASC,codigo ASC,color ASC;";
    $f = new Functions();
    echo json_encode($f->getResultArray($sql));
}
