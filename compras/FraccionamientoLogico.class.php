    ...
    function __construct(){
       ...
       //$estado = 'Cerrada';
        ...
        if($accion == "" || $accion == "Listar"){
            ...
            $sql = "select id_ent,suc,usuario,cod_prov,proveedor,DATE_FORMAT(fecha,'%d-%m-%Y') as fecha,moneda,invoice,folio_num,origen,pais_origen,sap_doc,estado from entrada_merc where estado in('Cerrada','En_Transito') ";
