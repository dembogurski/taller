        ...
        success: function (data) {               
            ...
            if(data.length>0){
                for (var i in data) {  
                    ...
                    $("#lotes").append("<tr class='fila_lote' data-art='"+codigo+"' data-pol='"+Politica+"'><td class='item' id='lote_"+i+"'>"+Lote+"</td><td class='itemc'>"+Suc+"</td><td style='cursor:pointer' data-lote='"+Lote+"' onclick=selectColor('"+color_class+"') class='color_"+i+" "+color_class+" item' >"+Color+"</td><td class='itemc' id='cant_"+i+"'>"+Stock+"</td> \n\
