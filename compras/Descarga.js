    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i in data) {
                ...
                <td class='item "+sclass+"  "+have_img_class+" art_max' id='codigo_"+ AbsEntry +"'  style='display:none' > " + Articulo +"  </td>\n\
...
function saveLine(AbsEntry, recibido) {
    ...
    if(!( (qty_ticket > each_quty_min) && (qty_ticket < each_quty_max)) && (recibido == "Si")){
        alert("Qty Ticket Fuera del Rango del 20% sobre E.Qty,   Q.Ticket no se encuentra entre   "+each_quty_min + "  y "+each_quty_max);
        return;
    }
...
function modificarGramaje(){
 ...
 console.log(gramaje_actual+"   "+gramaje_nuevo);
 if(gramaje_nuevo > 0 ){
     console.log( "  2   "  );
