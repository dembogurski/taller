...
class BarcodePrinterDescargaLoteVirtual {
    ...
    function __construct() {
        ...
        $db->Query("SELECT id_ent as ref, d.codigo,lote,d.descrip,d.um,CONCAT(cod_catalogo,'-',fab_color_cod) as fab_color_cod,color,design,composicion,ancho_real,quty_ticket,kg_desc FROM entrada_det d, articulos a WHERE a.codigo = d.codigo and id_det = $AbsEntry and id_ent = $id_ent;");
