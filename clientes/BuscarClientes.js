...
function bc_buscarCliente() {
    ...
    var param = { "action": "buscar_clientes", "hit": hit };
...
function verMapa(){
    ...
    var ip =  window.location.href.substring(7,100).substring( 0,  window.location.href.substring(7,100). indexOf("marijoa_sap/Main.class.php") - 1   );
