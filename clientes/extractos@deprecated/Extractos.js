...
function switch_view(){  
    ...
    if(ch){
        ...
        $(".det_pago_vacio").prop("colspan","10");
        $(".det_cab").prop("colspan","5");
        $(".det_total").prop("colspan","5");
        $(".titulo_extracto").prop("colspan","9");
        ...
        $(".det_total").prop("colspan","7");
        $(".titulo_extracto").prop("colspan","12");
         $(".cli_data").prop("colspan","11");
    }    
}
